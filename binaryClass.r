#################################
# Aplicación de modelos de clasificación binario
#################################
...
# Linkedin: https://www.linkedin.com/in/bastianbarrazam/
...
modelPipeline <- function(df, model, varNum, varCat){
  ...
  resultado <- list(Predicciones = predicciones, SplitData = splitData, PCA = PCA)
